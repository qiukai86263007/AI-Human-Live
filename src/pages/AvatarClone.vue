<template>
  <div class="p-6">
    ...
    <div v-if="!avatarList.length" class="flex flex-col items-center justify-center py-20">
      ...
      <div class="text-gray-400 mb-4">
        暂无克隆形象，请新建克隆形象，克隆完成后可以在我的主播中找到并使用
      </div>
    </div>
    ...
    <div v-else>
      <div
        ...
        :key="avatar.id"
        class="avatar-card bg-[#252632] rounded-lg p-4 mb-4"
      >
    ...
    >
      <div class="clone-form">
        <div class="mb-4">
          ...
          <div>
            <span
              >上传一段视频文件，用于克隆形象。建议上传视频时长为10-30秒，视频质量清晰，避免多人出现、明显遮挡等情况，视频封面将作为主播形象照片</span
            >
          </div>
