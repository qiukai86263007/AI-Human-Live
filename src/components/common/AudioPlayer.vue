  ...
  <div class="border rounded-lg py-2">
    ...
    <div v-if="!recordVisible && waveUrl" class="h-10 px-2 flex items-center">
      ...
      <div class="ml-3">
        ...
        <a-tooltip :content="$t('重新录制')" v-if="recordUrl && !isTrimming">
        ...
        <a-tooltip :content="$t('裁剪音频')" v-if="!isTrimming && props.trimEnable">
        ...
        <a-tooltip :content="$t('确定裁剪')" v-if="isTrimming && props.trimEnable">
        ...
        <a-tooltip :content="$t('下载音频')" v-if="!isTrimming && props.downloadEnable">
        ...
        <a-tooltip :content="$t('录制音频')" v-if="props.recordEnable && !isTrimming && !recordUrl">
